    ...
    <div className="mb-6 flex flex-col items-center gap-3">
      ...
      <div className="nx-glow" style={{ width: 72, height: 72, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <svg width="68" height="68" viewBox="0 0 68 68" fill="none" aria-hidden="true">
          ...
          <polygon className="nx-spin" points="34,14 47,20 56,32 56,36 47,48 34,54 21,48 12,36 12,32 21,20" stroke="rgba(0,200,255,0.72)" strokeWidth="1" fill="none" />
      ...
      <div className="text-center">
        ...
        <div className="mt-2 flex justify-center">
          <span className="rounded-full px-2 py-0.5 text-[9px] font-bold uppercase tracking-[0.16em]" style={{ background: 'rgba(0,200,255,0.16)', border: '1px solid rgba(0,200,255,0.45)', color: '#7DE5FF' }}>Professional</span>
        </div>
