              ...
              <table className="w-full border-collapse text-[12px]">
                ...
                <tbody style={{ color: '#dbeaf7' }}>
                  {loading ? (
                    ...
                    <tr><td colSpan={7} className="py-6 text-center text-[11px]" style={{ color: 'rgba(255,255,255,0.45)' }}>No open deals yet. Convert a lead or start a new opportunity.</td></tr>
                  ) : analysis.map(row => {
                    ...
                    return (
                      <tr key={row.id} className="cursor-pointer border-b transition-colors hover:bg-white/5" style={{ borderColor: 'rgba(140,170,200,0.1)' }} onClick={() => void openDeal(row.id)}>
                        ...
                        <td className="py-2 truncate" style={{ color: '#98abbd', maxWidth: 160 }}>{row.next_step || '—'}</td>
                      </tr>
                    )
                  })}
                </tbody>
