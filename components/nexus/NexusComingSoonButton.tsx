...
export function NexusComingSoonButton({ label }: NexusComingSoonButtonProps) {
  return (
    <button
      ...
      style={{
        background: 'linear-gradient(135deg, rgba(255,255,255,0.075), rgba(95,184,224,0.055))',
        border: '1px solid rgba(255,255,255,0.22)',
        color: 'rgba(255,255,255,0.92)',
        boxShadow: '0 0 16px rgba(95,184,224,0.08), inset 0 1px 0 rgba(255,255,255,0.08)',
      }}
    ...
    >
      ...
      <span
        ...
        style={{
          background: 'rgba(95,184,224,0.12)',
