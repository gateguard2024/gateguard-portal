/**
 * POST /api/nexus/jobs/job-window/[id]/attachment-url
 *
 * Signed Supabase Storage upload URL so the browser uploads a job photo/file
 * directly. After the PUT, the client calls the job-window POST with
 * action 'add_attachment' to record it (scope-checked there).
 */
