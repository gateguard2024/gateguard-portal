/**
 * POST /api/nexus/opps/opportunity-window/[id]/attachment-url
 *
 ...
 * opportunity-window POST with action 'add_attachment' to record it (scope-checked).
 *
...
// Shared CRM attachment bucket (leads + opportunities); paths are namespaced by record id.
