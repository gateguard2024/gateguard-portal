...
Here's the model that's getting a lot of attention from property managers right now:
  ...
  • You bill $10/month per unit for GateGuard's managed access service
  • We maintain ALL gates, cameras, readers, and wiring — no more repair calls to you

For a 100-unit property like ${prop}, that's $1,000/month in new revenue and near-zero maintenance overhead. That's a direct NOI lift — which rolls straight into cap rate improvement when you're ready to refinance or sell.

The best part: we handle the install, we own the hardware relationship, and we train residents. You collect the checks.
...
<head>
  ...
  <style>
    ...
    .header { background: #0C111D; padding: 28px 32px; }
    .header-logo { color: #6B7EFF; font-size: 18px; font-weight: 700; letter-spacing: -0.5px; }
    .header-tagline { color: #94a3b8; font-size: 12px; margin-top: 4px; }
    .body { padding: 32px; }
    .greeting { font-size: 16px; color: #0f172a; margin-bottom: 20px; }
    .callout { background: #f0f4ff; border-left: 4px solid #6B7EFF; border-radius: 0 8px 8px 0; padding: 20px 24px; margin: 24px 0; }
    .callout-title { font-size: 13px; font-weight: 700; color: #6B7EFF; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 12px; }
    .bullet { display: flex; align-items: flex-start; gap: 10px; margin-bottom: 10px; font-size: 14px; color: #1e293b; }
    .bullet-dot { width: 20px; height: 20px; background: #6B7EFF; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 1px; }
    ...
    .cta-button { display: inline-block; background: #6B7EFF; color: #ffffff !important; text-decoration: none; font-size: 14px; font-weight: 600; padding: 13px 28px; border-radius: 8px; margin: 8px 0 24px 0; }
    ...
    .sig-contact { color: #6B7EFF; font-size: 13px; margin-top: 6px; }
...
<body>
  <div class="wrapper">
    <div class="header">
      <div class="header-logo">GateGuard</div>
    ...
    <div class="body">
      ...
      <div class="callout">
        ...
        <div class="bullet">
          <div class="bullet-dot"><svg viewBox="0 0 8 8" width="8" height="8"><circle cx="4" cy="4" r="3"/></svg></div>
          <div>You bill <strong>$10/month per unit</strong> for GateGuard's managed access service</div>
        </div>
        <div class="bullet">
          <div class="bullet-dot"><svg viewBox="0 0 8 8" width="8" height="8"><circle cx="4" cy="4" r="3"/></svg></div>
          <div>We maintain <strong>ALL gates, cameras, readers, and wiring</strong> — no more repair calls to you</div>
        </div>
      </div>

      <div class="highlight-box">
        <div class="highlight-number">$1,000/mo</div>
      ...
      <p>We handle the install, we own the hardware relationship, and we train residents. <strong>You collect the checks.</strong></p>
      ...
      <div class="sig">
        ...
        <div class="sig-title">CEO, GateGuard</div>
        <div class="sig-contact">rfeldman@gateguard.co &nbsp;·&nbsp; (404) 618-8000</div>
      </div>
    </div>
