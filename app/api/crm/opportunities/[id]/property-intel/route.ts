/**
 * PATCH /api/crm/opportunities/[id]/property-intel
 * Update property_intel on an opportunity — rep corrections during sales cycle.
...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const merged = { ...(opp?.property_intel ?? {}), ...updates, updated_by: userId, updated_at: new Date().toISOString() }
